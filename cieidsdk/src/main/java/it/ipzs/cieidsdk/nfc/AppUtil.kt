    ...
    companion object {
        ...
        internal fun lenToBytes(value: Int): ByteArray {
            ...
            when {
                ...
                else -> throw AppUtilException("dati troppo lunghi")
            }
        }
        ...
        fun tagToByte(value: Int): ByteArray {
            when {
                ...
                else -> throw AppUtilException("tag troppo lungo")
            }
        }
         ...
         * @param numParam la dimensione del subset
         * @return un array di byte subset
         * @throws Exception
         */
        @Throws(Exception::class)
        fun getSub(array: ByteArray, start: Int, numParam: Int): ByteArray {
            var num = numParam
        ...
        fun getIsoPad(data: ByteArray): ByteArray {
            val padLen: Int = if (data.size and 0x7 == 0)
                data.size + 8
            else
